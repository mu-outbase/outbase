const CACHE_NAME='outbase-field03-v1667-native';
const CORE_ASSETS=[
  './','./index.html','./manifest.json?v=outbase-v1667-native','./icons/outbase-192.png','./icons/outbase-512.png',
  ...
  './style-shell.css?v=outbase-v1667-native','./style-design-system.css?v=outbase-v1667-native','./style-native-app.css?v=outbase-v1667-native',
  './src/config/version.js?v=outbase-v1667-native','./src/config/module-manifest.js?v=outbase-v1667-native',
  './src/runtime/script-loader.js?v=outbase-v1667-native','./src/runtime/lifecycle.js?v=outbase-v1667-native','./src/state/app-state.js?v=outbase-v1667-native',
  './src/router.js?v=outbase-v1667-native','./src/design/theme-controller.js?v=outbase-v1667-native','./src/main.js?v=outbase-v1667-native',
  ...
  './src/domain/shared/read-utils.js?v=outbase-v1667-native','./src/domain/plans/plan-domain.js?v=outbase-v1667-native',
  './src/domain/preparation/preparation-domain.js?v=outbase-v1667-native','./src/domain/vault/vault-domain.js?v=outbase-v1667-native',
  './src/screens/plan/plan-screen-model.js?v=outbase-v1667-native','./src/screens/preparation/preparation-screen-model.js?v=outbase-v1667-native',
  './src/screens/vault/vault-screen-model.js?v=outbase-v1667-native','./src/domain/bootstrap.js?v=outbase-v1667-native',
  './src/domain/home/home-domain.js?v=outbase-v1667-native','./src/screens/home/home-screen-model.js?v=outbase-v1667-native',
  './src/domain/filters/family-filter-domain.js?v=outbase-v1667-native','./src/domain/calendar/calendar-domain.js?v=outbase-v1667-native',
  './src/screens/calendar/calendar-screen-model.js?v=outbase-v1667-native','./src/domain/activity/activity-detail-domain.js?v=outbase-v1667-native',
  './src/screens/activity/activity-detail-screen-model.js?v=outbase-v1667-native','./src/shell/legacy-adapter.js?v=outbase-v1667-native',
  './src/shell/modal-stack.js?v=outbase-v1667-native','./src/shell/shell-model.js?v=outbase-v1667-native',
  './src/shell/shell-renderer.js?v=outbase-v1667-native','./src/shell/bootstrap.js?v=outbase-v1667-native',
