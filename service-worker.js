const CACHE_NAME='outbase-field03-v1663-calendar-v2-r1';
const CORE_ASSETS=[
  ...
  './style-shell.css?v=outbase-v1663-visual','./style-design-system.css?v=outbase-v1663-visual','./style-home-v36.css?v=outbase-v1663-home-v36-r34','./style-calendar-v2.css?v=outbase-calendar-v2-r1','./src/config/version.js?v=outbase-v1663-home-v36-r34','./src/config/module-manifest.js?v=outbase-v1663-visual',
  ...
  './src/calendar-v2/outbase-calendar-v2.js?v=outbase-calendar-v2-r1','./outbase_library10a/style.css?v=outbase-field03-compact-2'
];
