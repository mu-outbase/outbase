const CACHE_NAME='outbase-field03-v165.1-android-hotfix';
const CORE_ASSETS=[
  './','./index.html','./manifest.json?v=outbase-v165.1-android-hotfix','./icons/outbase-192.png','./icons/outbase-512.png',
  ...
  './style-shell.css?v=outbase-v165.1-android-hotfix','./src/config/version.js?v=outbase-v165.1-android-hotfix','./src/config/module-manifest.js?v=outbase-v165.1-android-hotfix',
  './src/runtime/script-loader.js?v=outbase-v165.1-android-hotfix','./src/runtime/lifecycle.js?v=outbase-v165.1-android-hotfix','./src/state/app-state.js?v=outbase-v165.1-android-hotfix',
  './src/router.js?v=outbase-v165.1-android-hotfix','./src/main.js?v=outbase-v165.1-android-hotfix',
  ...
  './src/domain/shared/read-utils.js?v=outbase-v165.1-android-hotfix','./src/domain/plans/plan-domain.js?v=outbase-v165.1-android-hotfix',
  './src/domain/preparation/preparation-domain.js?v=outbase-v165.1-android-hotfix','./src/domain/vault/vault-domain.js?v=outbase-v165.1-android-hotfix',
  './src/screens/plan/plan-screen-model.js?v=outbase-v165.1-android-hotfix','./src/screens/preparation/preparation-screen-model.js?v=outbase-v165.1-android-hotfix',
  './src/screens/vault/vault-screen-model.js?v=outbase-v165.1-android-hotfix','./src/domain/bootstrap.js?v=outbase-v165.1-android-hotfix',
  './src/domain/home/home-domain.js?v=outbase-v165.1-android-hotfix','./src/screens/home/home-screen-model.js?v=outbase-v165.1-android-hotfix',
  './src/domain/filters/family-filter-domain.js?v=outbase-v165.1-android-hotfix','./src/domain/calendar/calendar-domain.js?v=outbase-v165.1-android-hotfix',
  './src/screens/calendar/calendar-screen-model.js?v=outbase-v165.1-android-hotfix','./src/domain/activity/activity-detail-domain.js?v=outbase-v165.1-android-hotfix',
  './src/screens/activity/activity-detail-screen-model.js?v=outbase-v165.1-android-hotfix','./src/shell/legacy-adapter.js?v=outbase-v165.1-android-hotfix',
  './src/shell/modal-stack.js?v=outbase-v165.1-android-hotfix','./src/shell/shell-model.js?v=outbase-v165.1-android-hotfix',
  './src/shell/shell-renderer.js?v=outbase-v165.1-android-hotfix','./src/shell/bootstrap.js?v=outbase-v165.1-android-hotfix',
