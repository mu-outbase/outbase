const CACHE_NAME='outbase-field03-v1668-quiet';
const CORE_ASSETS=[
  './','./index.html','./manifest.json?v=outbase-v1668-quiet','./icons/outbase-192.png','./icons/outbase-512.png',
  ...
  './style-shell.css?v=outbase-v1668-quiet','./style-design-system.css?v=outbase-v1668-quiet','./style-native-app.css?v=outbase-v1668-quiet',
  './src/config/version.js?v=outbase-v1668-quiet','./src/config/module-manifest.js?v=outbase-v1668-quiet',
  './src/runtime/script-loader.js?v=outbase-v1668-quiet','./src/runtime/lifecycle.js?v=outbase-v1668-quiet','./src/state/app-state.js?v=outbase-v1668-quiet',
  './src/router.js?v=outbase-v1668-quiet','./src/design/theme-controller.js?v=outbase-v1668-quiet','./src/main.js?v=outbase-v1668-quiet',
  ...
  './src/domain/shared/read-utils.js?v=outbase-v1668-quiet','./src/domain/plans/plan-domain.js?v=outbase-v1668-quiet',
  './src/domain/preparation/preparation-domain.js?v=outbase-v1668-quiet','./src/domain/vault/vault-domain.js?v=outbase-v1668-quiet',
  './src/screens/plan/plan-screen-model.js?v=outbase-v1668-quiet','./src/screens/preparation/preparation-screen-model.js?v=outbase-v1668-quiet',
  './src/screens/vault/vault-screen-model.js?v=outbase-v1668-quiet','./src/domain/bootstrap.js?v=outbase-v1668-quiet',
  './src/domain/home/home-domain.js?v=outbase-v1668-quiet','./src/screens/home/home-screen-model.js?v=outbase-v1668-quiet',
  './src/domain/filters/family-filter-domain.js?v=outbase-v1668-quiet','./src/domain/calendar/calendar-domain.js?v=outbase-v1668-quiet',
  './src/screens/calendar/calendar-screen-model.js?v=outbase-v1668-quiet','./src/domain/activity/activity-detail-domain.js?v=outbase-v1668-quiet',
  './src/screens/activity/activity-detail-screen-model.js?v=outbase-v1668-quiet','./src/shell/legacy-adapter.js?v=outbase-v1668-quiet',
  './src/shell/modal-stack.js?v=outbase-v1668-quiet','./src/shell/shell-model.js?v=outbase-v1668-quiet',
  './src/shell/shell-renderer.js?v=outbase-v1668-quiet','./src/shell/bootstrap.js?v=outbase-v1668-quiet',
