const CACHE_NAME='outbase-field03-v1662-density';
const CORE_ASSETS=[
  './','./index.html','./manifest.json?v=outbase-v1662-density','./icons/outbase-192.png','./icons/outbase-512.png',
  ...
  './style-shell.css?v=outbase-v1662-density','./style-design-system.css?v=outbase-v1662-density','./src/config/version.js?v=outbase-v1662-density','./src/config/module-manifest.js?v=outbase-v1662-density',
  './src/runtime/script-loader.js?v=outbase-v1662-density','./src/runtime/lifecycle.js?v=outbase-v1662-density','./src/state/app-state.js?v=outbase-v1662-density',
  './src/router.js?v=outbase-v1662-density','./src/design/theme-controller.js?v=outbase-v1662-density','./src/main.js?v=outbase-v1662-density',
  ...
  './src/domain/shared/read-utils.js?v=outbase-v1662-density','./src/domain/plans/plan-domain.js?v=outbase-v1662-density',
  './src/domain/preparation/preparation-domain.js?v=outbase-v1662-density','./src/domain/vault/vault-domain.js?v=outbase-v1662-density',
  './src/screens/plan/plan-screen-model.js?v=outbase-v1662-density','./src/screens/preparation/preparation-screen-model.js?v=outbase-v1662-density',
  './src/screens/vault/vault-screen-model.js?v=outbase-v1662-density','./src/domain/bootstrap.js?v=outbase-v1662-density',
  './src/domain/home/home-domain.js?v=outbase-v1662-density','./src/screens/home/home-screen-model.js?v=outbase-v1662-density',
  './src/domain/filters/family-filter-domain.js?v=outbase-v1662-density','./src/domain/calendar/calendar-domain.js?v=outbase-v1662-density',
  './src/screens/calendar/calendar-screen-model.js?v=outbase-v1662-density','./src/domain/activity/activity-detail-domain.js?v=outbase-v1662-density',
  './src/screens/activity/activity-detail-screen-model.js?v=outbase-v1662-density','./src/shell/legacy-adapter.js?v=outbase-v1662-density',
  './src/shell/modal-stack.js?v=outbase-v1662-density','./src/shell/shell-model.js?v=outbase-v1662-density',
  './src/shell/shell-renderer.js?v=outbase-v1662-density','./src/shell/bootstrap.js?v=outbase-v1662-density',
