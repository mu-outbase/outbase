const CACHE_NAME='outbase-field03-v1663-renderer-direct-fix-v1';
const CORE_ASSETS=[
  ...
  './style-calendar-route-v3.css?v=outbase-renderer-direct-fix-v1','./calendar-formal-v44.html','./calendar-formal-v44.css?v=outbase-renderer-direct-fix-v1','./calendar-formal-v44.js?v=outbase-renderer-direct-fix-v1','./style-shell.css?v=outbase-v1663-visual','./style-design-system.css?v=outbase-v1663-visual','./style-home-v36.css?v=outbase-v1663-home-v36-r34','./src/config/version.js?v=outbase-v1663-home-v36-r34','./src/config/module-manifest.js?v=outbase-v1663-visual-recovery-r4',
