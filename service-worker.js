const CACHE_NAME='outbase-field03-v1665-editorial';
const CORE_ASSETS=[
  './','./index.html','./manifest.json?v=outbase-v1665-editorial','./icons/outbase-192.png','./icons/outbase-512.png',
  ...
  './style-shell.css?v=outbase-v1665-editorial','./style-design-system.css?v=outbase-v1665-editorial','./src/config/version.js?v=outbase-v1665-editorial','./src/config/module-manifest.js?v=outbase-v1665-editorial',
  './src/runtime/script-loader.js?v=outbase-v1665-editorial','./src/runtime/lifecycle.js?v=outbase-v1665-editorial','./src/state/app-state.js?v=outbase-v1665-editorial',
  './src/router.js?v=outbase-v1665-editorial','./src/design/theme-controller.js?v=outbase-v1665-editorial','./src/main.js?v=outbase-v1665-editorial',
  ...
  './src/domain/shared/read-utils.js?v=outbase-v1665-editorial','./src/domain/plans/plan-domain.js?v=outbase-v1665-editorial',
  './src/domain/preparation/preparation-domain.js?v=outbase-v1665-editorial','./src/domain/vault/vault-domain.js?v=outbase-v1665-editorial',
  './src/screens/plan/plan-screen-model.js?v=outbase-v1665-editorial','./src/screens/preparation/preparation-screen-model.js?v=outbase-v1665-editorial',
  './src/screens/vault/vault-screen-model.js?v=outbase-v1665-editorial','./src/domain/bootstrap.js?v=outbase-v1665-editorial',
  './src/domain/home/home-domain.js?v=outbase-v1665-editorial','./src/screens/home/home-screen-model.js?v=outbase-v1665-editorial',
  './src/domain/filters/family-filter-domain.js?v=outbase-v1665-editorial','./src/domain/calendar/calendar-domain.js?v=outbase-v1665-editorial',
  './src/screens/calendar/calendar-screen-model.js?v=outbase-v1665-editorial','./src/domain/activity/activity-detail-domain.js?v=outbase-v1665-editorial',
  './src/screens/activity/activity-detail-screen-model.js?v=outbase-v1665-editorial','./src/shell/legacy-adapter.js?v=outbase-v1665-editorial',
  './src/shell/modal-stack.js?v=outbase-v1665-editorial','./src/shell/shell-model.js?v=outbase-v1665-editorial',
  './src/shell/shell-renderer.js?v=outbase-v1665-editorial','./src/shell/bootstrap.js?v=outbase-v1665-editorial',
