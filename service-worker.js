const CACHE_NAME='outbase-field03-v1666-magazine';
const CORE_ASSETS=[
  './','./index.html','./manifest.json?v=outbase-v1666-magazine','./icons/outbase-192.png','./icons/outbase-512.png',
  ...
  './style-shell.css?v=outbase-v1666-magazine','./style-design-system.css?v=outbase-v1666-magazine','./src/config/version.js?v=outbase-v1666-magazine','./src/config/module-manifest.js?v=outbase-v1666-magazine',
  './src/runtime/script-loader.js?v=outbase-v1666-magazine','./src/runtime/lifecycle.js?v=outbase-v1666-magazine','./src/state/app-state.js?v=outbase-v1666-magazine',
  './src/router.js?v=outbase-v1666-magazine','./src/design/theme-controller.js?v=outbase-v1666-magazine','./src/main.js?v=outbase-v1666-magazine',
  ...
  './src/domain/shared/read-utils.js?v=outbase-v1666-magazine','./src/domain/plans/plan-domain.js?v=outbase-v1666-magazine',
  './src/domain/preparation/preparation-domain.js?v=outbase-v1666-magazine','./src/domain/vault/vault-domain.js?v=outbase-v1666-magazine',
  './src/screens/plan/plan-screen-model.js?v=outbase-v1666-magazine','./src/screens/preparation/preparation-screen-model.js?v=outbase-v1666-magazine',
  './src/screens/vault/vault-screen-model.js?v=outbase-v1666-magazine','./src/domain/bootstrap.js?v=outbase-v1666-magazine',
  './src/domain/home/home-domain.js?v=outbase-v1666-magazine','./src/screens/home/home-screen-model.js?v=outbase-v1666-magazine',
  './src/domain/filters/family-filter-domain.js?v=outbase-v1666-magazine','./src/domain/calendar/calendar-domain.js?v=outbase-v1666-magazine',
  './src/screens/calendar/calendar-screen-model.js?v=outbase-v1666-magazine','./src/domain/activity/activity-detail-domain.js?v=outbase-v1666-magazine',
  './src/screens/activity/activity-detail-screen-model.js?v=outbase-v1666-magazine','./src/shell/legacy-adapter.js?v=outbase-v1666-magazine',
  './src/shell/modal-stack.js?v=outbase-v1666-magazine','./src/shell/shell-model.js?v=outbase-v1666-magazine',
  './src/shell/shell-renderer.js?v=outbase-v1666-magazine','./src/shell/bootstrap.js?v=outbase-v1666-magazine',
