const CACHE_NAME='outbase-field03-integrated-production1';
const APP_SHELL=['./','./index.html','./style.css?v=outbase-field03-integrated-production1','./src/app.js?v=outbase-field03-integrated-production1','./manifest.json?v=outbase-field03-integrated-production1','./outbase_library10a/style.css?v=outbase-field03-integrated-production1'];
