const CACHE_NAME='outbase-field03-phase14';
const CORE_ASSETS=[
  './','./index.html',
  './style.css?v=outbase-field03-phase14','./style-flow.css?v=outbase-field03-phase14','./style-memo.css?v=outbase-field03-phase14',
  './style-review.css?v=outbase-field03-phase14','./style-entry.css?v=outbase-field03-phase14','./style-activity.css?v=outbase-field03-phase14','./style-chappy.css?v=outbase-field03-phase14',
  './src/app.js?v=outbase-field03-phase14','./src/outbase-core.js?v=outbase-field03-phase14',
  './src/outbase-chappy.js?v=outbase-field03-phase14','./src/outbase-chappy-ui.js?v=outbase-field03-phase14','./src/outbase-import.js?v=outbase-field03-phase14','./src/outbase-memo-ui.js?v=outbase-field03-phase14',
  './src/outbase-review-ui.js?v=outbase-field03-phase14','./src/outbase-flow.js?v=outbase-field03-phase14','./src/outbase-entry.js?v=outbase-field03-phase14',
  './src/outbase-activity.js?v=outbase-field03-phase14','./manifest.json?v=outbase-field03-phase14',
  './outbase_library10a/style.css?v=outbase-field03-phase14'
];
