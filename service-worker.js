const CACHE_NAME='outbase-field03-v166-formal-design';
const CORE_ASSETS=[
  './','./index.html','./manifest.json?v=outbase-v166-formal-design','./icons/outbase-192.png','./icons/outbase-512.png',
  ...
  './style-shell.css?v=outbase-v166-formal-design','./style-design-system.css?v=outbase-v166-formal-design','./src/config/version.js?v=outbase-v166-formal-design','./src/config/module-manifest.js?v=outbase-v166-formal-design',
  './src/runtime/script-loader.js?v=outbase-v166-formal-design','./src/runtime/lifecycle.js?v=outbase-v166-formal-design','./src/state/app-state.js?v=outbase-v166-formal-design',
  './src/router.js?v=outbase-v166-formal-design','./src/design/theme-controller.js?v=outbase-v166-formal-design','./src/main.js?v=outbase-v166-formal-design',
  ...
  './src/domain/shared/read-utils.js?v=outbase-v166-formal-design','./src/domain/plans/plan-domain.js?v=outbase-v166-formal-design',
  './src/domain/preparation/preparation-domain.js?v=outbase-v166-formal-design','./src/domain/vault/vault-domain.js?v=outbase-v166-formal-design',
  './src/screens/plan/plan-screen-model.js?v=outbase-v166-formal-design','./src/screens/preparation/preparation-screen-model.js?v=outbase-v166-formal-design',
  './src/screens/vault/vault-screen-model.js?v=outbase-v166-formal-design','./src/domain/bootstrap.js?v=outbase-v166-formal-design',
  './src/domain/home/home-domain.js?v=outbase-v166-formal-design','./src/screens/home/home-screen-model.js?v=outbase-v166-formal-design',
  './src/domain/filters/family-filter-domain.js?v=outbase-v166-formal-design','./src/domain/calendar/calendar-domain.js?v=outbase-v166-formal-design',
  './src/screens/calendar/calendar-screen-model.js?v=outbase-v166-formal-design','./src/domain/activity/activity-detail-domain.js?v=outbase-v166-formal-design',
  './src/screens/activity/activity-detail-screen-model.js?v=outbase-v166-formal-design','./src/shell/legacy-adapter.js?v=outbase-v166-formal-design',
  './src/shell/modal-stack.js?v=outbase-v166-formal-design','./src/shell/shell-model.js?v=outbase-v166-formal-design',
  './src/shell/shell-renderer.js?v=outbase-v166-formal-design','./src/shell/bootstrap.js?v=outbase-v166-formal-design',
