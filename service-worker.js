const CACHE_NAME='outbase-field03-core02';
const CORE_ASSETS=[
  './','./index.html',
  './style.css?v=outbase-field03-core02','./style-flow.css?v=outbase-field03-core02',
  './style-entry.css?v=outbase-field03-core02','./style-activity.css?v=outbase-field03-core02',
  './src/app.js?v=outbase-field03-core02','./src/outbase-core.js?v=outbase-field03-core02',
  './src/outbase-flow.js?v=outbase-field03-core02','./src/outbase-entry.js?v=outbase-field03-core02',
  './src/outbase-activity.js?v=outbase-field03-core02','./manifest.json?v=outbase-field03-core02',
  './outbase_library10a/style.css?v=outbase-field03-core02'
];
