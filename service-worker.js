const CACHE_NAME='outbase-field03-v1664-polish';
const CORE_ASSETS=[
  './','./index.html','./manifest.json?v=outbase-v1664-polish','./icons/outbase-192.png','./icons/outbase-512.png',
  ...
  './style-shell.css?v=outbase-v1664-polish','./style-design-system.css?v=outbase-v1664-polish','./src/config/version.js?v=outbase-v1664-polish','./src/config/module-manifest.js?v=outbase-v1664-polish',
  './src/runtime/script-loader.js?v=outbase-v1664-polish','./src/runtime/lifecycle.js?v=outbase-v1664-polish','./src/state/app-state.js?v=outbase-v1664-polish',
  './src/router.js?v=outbase-v1664-polish','./src/design/theme-controller.js?v=outbase-v1664-polish','./src/main.js?v=outbase-v1664-polish',
  ...
  './src/domain/shared/read-utils.js?v=outbase-v1664-polish','./src/domain/plans/plan-domain.js?v=outbase-v1664-polish',
  './src/domain/preparation/preparation-domain.js?v=outbase-v1664-polish','./src/domain/vault/vault-domain.js?v=outbase-v1664-polish',
  './src/screens/plan/plan-screen-model.js?v=outbase-v1664-polish','./src/screens/preparation/preparation-screen-model.js?v=outbase-v1664-polish',
  './src/screens/vault/vault-screen-model.js?v=outbase-v1664-polish','./src/domain/bootstrap.js?v=outbase-v1664-polish',
  './src/domain/home/home-domain.js?v=outbase-v1664-polish','./src/screens/home/home-screen-model.js?v=outbase-v1664-polish',
  './src/domain/filters/family-filter-domain.js?v=outbase-v1664-polish','./src/domain/calendar/calendar-domain.js?v=outbase-v1664-polish',
  './src/screens/calendar/calendar-screen-model.js?v=outbase-v1664-polish','./src/domain/activity/activity-detail-domain.js?v=outbase-v1664-polish',
  './src/screens/activity/activity-detail-screen-model.js?v=outbase-v1664-polish','./src/shell/legacy-adapter.js?v=outbase-v1664-polish',
  './src/shell/modal-stack.js?v=outbase-v1664-polish','./src/shell/shell-model.js?v=outbase-v1664-polish',
  './src/shell/shell-renderer.js?v=outbase-v1664-polish','./src/shell/bootstrap.js?v=outbase-v1664-polish',
