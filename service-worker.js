const CACHE_NAME='outbase-field03-v1663-calendar-stable-nav-v1';
const CORE_ASSETS=[
  ...
  './style-calendar-route-v3.css?v=outbase-calendar-stable-nav-v1','./calendar-formal-v44.html','./calendar-formal-v44.css?v=outbase-calendar-stable-nav-v1','./calendar-formal-v44.js?v=outbase-calendar-stable-nav-v1','./style-shell.css?v=outbase-v1663-visual','./style-design-system.css?v=outbase-v1663-visual','./style-home-v36.css?v=outbase-v1663-home-v36-r34','./src/config/version.js?v=outbase-v1663-home-v36-r34','./src/config/module-manifest.js?v=outbase-v1663-visual-recovery-r4',
  ...
  './src/shell/shell-renderer.js?v=outbase-v1663-home-v36-r34','./src/shell/bootstrap.js?v=outbase-v1663-home-v36-r34','./src/shell/navigation-audit-fix.js?v=outbase-v1663-home-v36-r34-nav1','./src/shell/calendar-route-v4.js?v=outbase-calendar-stable-nav-v1',
