const CACHE_NAME='outbase-field03-v16610-calendar-back-remove-v8';
const CORE_ASSETS=[
  ...
  './style-calendar-route-v3.css?v=outbase-calendar-back-remove-v8','./style-about-outbase.css?v=outbase-calendar-back-remove-v8','./calendar-formal-v44.html','./calendar-formal-v44.css?v=outbase-calendar-back-remove-v8','./calendar-formal-v44.js?v=outbase-calendar-back-remove-v8','./style-shell.css?v=outbase-v1663-visual','./style-design-system.css?v=outbase-v1663-visual','./style-home-v36.css?v=outbase-v1663-home-v36-r34','./src/config/version.js?v=outbase-calendar-back-remove-v8','./src/config/module-manifest.js?v=outbase-calendar-back-remove-v8',
  ...
  './src/screens/activity/activity-detail-screen-model.js?v=outbase-v1663-home-v36-r34','./src/shell/legacy-adapter.js?v=outbase-v16610-calendar-back-remove-v8',
  './src/shell/modal-stack.js?v=outbase-v16610-calendar-back-remove-v8','./src/shell/shell-model.js?v=outbase-v16610-calendar-back-remove-v8',
  './src/shell/shell-renderer.js?v=outbase-v16610-calendar-back-remove-v8','./src/shell/bootstrap.js?v=outbase-v16610-calendar-back-remove-v8','./src/shell/about-outbase.js?v=outbase-calendar-back-remove-v8','./src/shell/shell-renderer-direct-fix.js?v=outbase-v16610-calendar-back-remove-v8','./src/shell/navigation-audit-fix.js?v=outbase-v1663-home-v36-r34-nav1',
