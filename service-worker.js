const CACHE_NAME='outbase-field03-v1669-home';
const CORE_ASSETS=[
  './','./index.html','./manifest.json?v=outbase-v1669-home','./icons/outbase-192.png','./icons/outbase-512.png',
  ...
  './style-shell.css?v=outbase-v1669-home','./style-design-system.css?v=outbase-v1669-home','./style-native-app.css?v=outbase-v1669-home','./style-v1669-home.css?v=outbase-v1669-home',
  './src/config/version.js?v=outbase-v1669-home','./src/config/module-manifest.js?v=outbase-v1669-home',
  './src/runtime/script-loader.js?v=outbase-v1669-home','./src/runtime/lifecycle.js?v=outbase-v1669-home','./src/state/app-state.js?v=outbase-v1669-home',
  './src/router.js?v=outbase-v1669-home','./src/design/theme-controller.js?v=outbase-v1669-home','./src/main.js?v=outbase-v1669-home',
  ...
  './src/domain/shared/read-utils.js?v=outbase-v1669-home','./src/domain/plans/plan-domain.js?v=outbase-v1669-home',
  './src/domain/preparation/preparation-domain.js?v=outbase-v1669-home','./src/domain/vault/vault-domain.js?v=outbase-v1669-home',
  './src/screens/plan/plan-screen-model.js?v=outbase-v1669-home','./src/screens/preparation/preparation-screen-model.js?v=outbase-v1669-home',
  './src/screens/vault/vault-screen-model.js?v=outbase-v1669-home','./src/domain/bootstrap.js?v=outbase-v1669-home',
  './src/domain/home/home-domain.js?v=outbase-v1669-home','./src/screens/home/home-screen-model.js?v=outbase-v1669-home',
  './src/domain/filters/family-filter-domain.js?v=outbase-v1669-home','./src/domain/calendar/calendar-domain.js?v=outbase-v1669-home',
  './src/screens/calendar/calendar-screen-model.js?v=outbase-v1669-home','./src/domain/activity/activity-detail-domain.js?v=outbase-v1669-home',
  './src/screens/activity/activity-detail-screen-model.js?v=outbase-v1669-home','./src/shell/legacy-adapter.js?v=outbase-v1669-home',
  './src/shell/modal-stack.js?v=outbase-v1669-home','./src/shell/shell-model.js?v=outbase-v1669-home',
  './src/shell/shell-renderer.js?v=outbase-v1669-home','./src/shell/bootstrap.js?v=outbase-v1669-home',
