const CACHE_NAME='outbase-field03-integrated-production2';
const APP_SHELL=['./','./index.html','./style.css?v=outbase-field03-integrated-production2','./src/app.js?v=outbase-field03-integrated-production2','./manifest.json?v=outbase-field03-integrated-production2','./outbase_library10a/style.css?v=outbase-field03-integrated-production2'];
