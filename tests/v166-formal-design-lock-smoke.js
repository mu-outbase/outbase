...
assert(index.includes('style-design-system.css?v=outbase-v1661-performance'));
assert(index.includes('src/design/theme-controller.js?v=outbase-v1661-performance'));
assert(sw.includes('./style-design-system.css?v=outbase-v1661-performance'));
assert(sw.includes('./src/design/theme-controller.js?v=outbase-v1661-performance'));
assert.equal(JSON.parse(read('manifest.json')).version,'166.1');
