...
assert(index.includes('style-design-system.css?v=outbase-v1665-editorial'));
assert(index.includes('src/design/theme-controller.js?v=outbase-v1665-editorial'));
assert(sw.includes('./style-design-system.css?v=outbase-v1665-editorial'));
assert(sw.includes('./src/design/theme-controller.js?v=outbase-v1665-editorial'));
assert.equal(JSON.parse(read('manifest.json')).version,'166.4');
