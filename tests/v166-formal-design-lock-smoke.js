...
assert(sw.includes('./style-design-system.css?v=outbase-v166-formal-design'));
assert(sw.includes('./src/design/theme-controller.js?v=outbase-v166-formal-design'));
assert.equal(JSON.parse(read('manifest.json')).version,'166.0');
