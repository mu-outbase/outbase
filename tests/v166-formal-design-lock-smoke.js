...
assert(index.includes('style-design-system.css?v=outbase-v1664-polish'));
assert(index.includes('src/design/theme-controller.js?v=outbase-v1664-polish'));
assert(sw.includes('./style-design-system.css?v=outbase-v1664-polish'));
assert(sw.includes('./src/design/theme-controller.js?v=outbase-v1664-polish'));
