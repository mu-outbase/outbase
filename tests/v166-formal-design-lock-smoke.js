...
assert(index.includes('style-design-system.css?v=outbase-v1663-visual'));
assert(index.includes('src/design/theme-controller.js?v=outbase-v1663-visual'));
assert(sw.includes('./style-design-system.css?v=outbase-v1663-visual'));
assert(sw.includes('./src/design/theme-controller.js?v=outbase-v1663-visual'));
assert.equal(JSON.parse(read('manifest.json')).version,'166.3');
