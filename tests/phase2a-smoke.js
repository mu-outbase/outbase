...
assert.equal(context.OUTBASE_VERSION.app,'v166.3-visual-hierarchy-lock');
...
assert(index.includes('src/main.js?v=outbase-v1663-visual'));
assert(index.includes('style-shell.css?v=outbase-v1663-visual'));
