...
assert.equal(context.OUTBASE_VERSION.app,'v166.4-completion-polish-lock');
...
assert(index.includes('src/main.js?v=outbase-v1664-polish'));
assert(index.includes('style-shell.css?v=outbase-v1664-polish'));
