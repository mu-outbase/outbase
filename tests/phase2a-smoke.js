...
assert.equal(context.OUTBASE_VERSION.app,'v166.2-density-lock');
...
assert(index.includes('src/main.js?v=outbase-v1662-density'));
assert(index.includes('style-shell.css?v=outbase-v1662-density'));
