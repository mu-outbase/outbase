...
assert.equal(context.OUTBASE_VERSION.app,'v166.5-editorial-layout-lock');
...
assert(index.includes('src/main.js?v=outbase-v1665-editorial'));
assert(index.includes('style-shell.css?v=outbase-v1665-editorial'));
