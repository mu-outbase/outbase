(() => {
  ...
  if(!base||base.customLocationFixVersion==='r21')return;
  ...
  function withTarget(result,key){
    ...
    return Object.freeze({...result,targets:Object.freeze(targets),customLocationFix:'r21'});
  }
  ...
  function getDetail(plan,options={}){
    ...
    if(requestedPlace&&isHomeAlias(requestedPlace)){
  ...
  globalThis.OUTBASE_WEATHER_SERVICE_V1=Object.freeze({...base,refresh,getDetail,customLocationFixVersion:'r21'});
})();
