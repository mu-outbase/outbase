import { updateState, getState, patchState } from '../../core/store.js?v=core05-6-calendar-nav-20260703';
import { go } from '../../core/router.js?v=core05-6-calendar-nav-20260703';
import { extractReservationCandidate, createProjectFromCandidate, buildPracticalPrep, normalizePrepContext } from '../prep/prepEngine.js?v=core05-6-calendar-nav-20260703';
import { escapeHtml, toast } from '../../ui/components.js?v=core05-6-calendar-nav-20260703';
